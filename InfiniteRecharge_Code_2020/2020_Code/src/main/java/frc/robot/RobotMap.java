...
public class RobotMap {
    ...
    public static final int BALL_MOTOR = 1;
    public static final int WHEEL_GATE1 = 5;
    public static final int WHEEL_GATE2 = 4;

    public static final int INTAKE_MOTOR = 4;
    public static final int WRIST_MOTOR = 5;
    public static final int BELT_MOTOR = 2;

    public static final int REEL_MOTOR1 = 6;
    public static final int REEL_MOTOR2 = 7;
    public static final int WHEEL_MOTOR = 0;
    public static final int HOOK_MOTOR = 3;
